...
class _chatqueryitempageState extends State<chatqueryitempage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Query Chats",style:TextStyle(fontWeight: FontWeight.bold,color:appcolors.whiteColor),),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(height: 25,child: Expanded(child: Text("Aditya Narayan",style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: appcolors.primaryColor),overflow: TextOverflow.ellipsis,),)),
                                    Container(height: 20,child: Expanded(child: Text("online",style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 12),overflow: TextOverflow.ellipsis,),)),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                color: appcolors.whiteColor,
                                    child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: edittextsone( label: '', hint: 'Enter Texts', maxlength: 1000, controllers: s1,),
                                      )),
                              ),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Container(
                                ...
                                child:Icon(Icons.send,color: appcolors.whiteColor,size: 40,),
                              ),
                            ),
                          ],
                        ),
