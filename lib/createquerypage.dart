                      ...
                      child: DropdownButtonFormField(
                        ...
                        onChanged: (newVal) {
                          setState(() {
                            itemName = newVal;
                            for (int i = 0;
                                i < categoryClassItemlist.length;
                                i++) {
                              if (categoryClassItemlist[i]['ChatTopicName'] ==
                                  "$newVal") {
                                itemId =
                                    categoryClassItemlist[i]['ChatTopicId'];
                              }
                            }
                          });
                        },
                          ...
                          setState(() {
                            ...
                            if (itemName == null ||
                              ...
                              postquery(
                                  itemName.toString(),
                                  itemId.toString(),
                                  studescriptionController.text.toString(),
                                  context);
                            }
                          });
                        }),
