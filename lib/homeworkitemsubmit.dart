          ...
          child:  Column(
            children: [
                  ...
                  child: selectedImages.isEmpty
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: Center(
                            child: kIsWeb
                                ? Container(width:100,height: 100,child: ClipRRect(child: Image.network(selectedImages[index].path,fit: BoxFit.fill,),))
                                : Container(width:100,height: 100,child: ClipRRect(child: Image.file(selectedImages[index],fit: BoxFit.fill,)))),
                      );
                    },
                  ),
                ),
              ...
              Padding(
                ...
                child: Center(
                  child: InkWell(child: buttons(title: 'SUBMIT', onPress: () {  },width: 150,height: 50,),
                    onTap: (){
