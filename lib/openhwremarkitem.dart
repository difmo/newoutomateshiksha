            ...
            Padding(
              ...
              child: Container(
                child:  ClipRRect(
                    ...
                    child: Image.network('${widget.openrequest.pathimg}', fit: BoxFit.fill,
                    )),
              ),
            ),
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Expanded(child: Text("${widget.openrequest.HWRemark_text}",style: const TextStyle(fontWeight: FontWeight.w500,fontSize: 16),
              )),
                  ),
                )),
            )
